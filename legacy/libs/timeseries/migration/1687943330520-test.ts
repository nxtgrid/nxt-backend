...
export class Test1687943330520 implements MigrationInterface {

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`create table "mppt_forecast_snapshot_30_min" (
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query('drop table "mppt_forecast_snapshot_30_min"');
  }
