...
export class Test1687943234411 implements MigrationInterface {

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`create table "mppt_forecast_snapshot_3_h" (
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query('drop table "mppt_forecast_snapshot_3_h"');
  }
