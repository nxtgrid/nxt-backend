...
export class Test1694770502613 implements MigrationInterface {

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`create table "mppt_asset_snapshot_1_d" (
            created_at timestamp not null,
            mppt_id int not null,
            mppt_external_reference varchar,
            mppt_external_id varchar,
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query('drop table "mppt_asset_snapshot_1_d"');
  }
