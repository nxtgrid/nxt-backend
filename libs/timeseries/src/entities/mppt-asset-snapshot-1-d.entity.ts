...
@Index('mppt_asset_snapshot_1_d_created_at_idx', [ 'mppt_id', 'created_at' ])
@Entity('mppt_asset_snapshot_1_d')
export class MpptAssetSnapshot1D extends TimeseriesEntity {
