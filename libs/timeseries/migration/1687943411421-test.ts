...
export class Test1687943411421 implements MigrationInterface {

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`create table "mppt_energy_snapshot_15_min" (
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query('drop table "mppt_energy_snapshot_15_min"');
  }
